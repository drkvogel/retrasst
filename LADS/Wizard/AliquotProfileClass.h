...
#ifndef AliquotProfileClassH
#define AliquotProfileClassH
//---------------------------------------------------------------------------
class AliquotProfileClass{

public:
    AliquotProfileClass();
    AliquotProfileClass(AnsiString aName);
    AliquotProfileClass(AliquotProfileClass& aAliquotProfileClass);
    virtual __fastcall ~AliquotProfileClass();
