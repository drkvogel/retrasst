...
/** @file docs-WorklistEntriesView.h
  ...
  * The main program has a singleton WorklistEntriesView object, whose job it is
...
// For comments on methods, please see their implementations.
	...
	WorklistEntriesView(TSnapshotFrame *m, DataManager* dm, LogManager* lm, const std::string & configFilename);
	~WorklistEntriesView();
