...
namespace tut
{
    ...
    typedef test_group<RerunTestFixture, 1> RerunTestGroup;
	...
	{
		set_test_name("Rerun tests (todo!)");
...
"882290,118507091,27-06-2013 11:42:36,REVEAL,432560,-1019349,882431,-1031390,1.850  ,0,27-06-2013 11:57:47,1.85 ,27-06-2013 10:57:49,0,,,,,,\n")
        ...
        HANDLE h = s->queueForRerun( -36845, lr.getRunID() );
