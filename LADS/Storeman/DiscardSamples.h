...
__published: // IDE-managed Components
	...
	TMenuItem *miNoteAll;
	TButton *btnAbort;
	TLabel *lblCurrentNote;
	void __fastcall grdResultsDrawCell( TObject *Sender, int ACol, int ARow, TRect &Rect,
		TGridDrawState State );
	void __fastcall grdResultsMouseUp( TObject *Sender, TMouseButton Button, TShiftState Shift,
		int X, int Y );
	...
	void __fastcall grdResultsContextPopup( TObject *Sender, TPoint MousePos, bool &Handled );
	void __fastcall btnNoteClick( TObject *Sender );
	void __fastcall cmbModeChange( TObject *Sender );
	void __fastcall grdResultsMouseMove( TObject *Sender, TShiftState Shift, int X, int Y );
