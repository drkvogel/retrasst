...
void RetrivalListGridUtils::reSizeGrid(TForm *Dlg,TStringGrid *StringGrid, bool  hideList)
{
	int TotalSize = 0;
	int MaxLenRow = 0;
...
void RetrivalListGridUtils::SortStringGrid(TStringGrid *GenStrGrid, int ThatCol)
{
	String TheSeparator = "@";
...
void RetrivalListGridUtils::setRichTextType(RichFont type,TRichEdit *RichEdit)
{
	switch (type)
	{
	case FONT_H1:
