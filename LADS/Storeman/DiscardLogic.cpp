...
bool
Cell::operator== ( const Cell & that ) const
{
...
void
Person::setFname( const std::string & fname )
{
    s_fname = fname;
    return;
}
...
void
Sample::setBarcode( const std::string & barcode )
{
...
std::string
Sample::getBarcode( ) const
{
	return getString("sbar");
}

void
Sample::setCryovialBarcode( const std::string & barcode )
{
...
std::string
Sample::getCryovialBarcode( ) const
{
	return getString("cbar");
}

void
Sample::setPersonId( const std::string & id )
{
	setString("pid", id);
	return;
}
...
std::string
Sample::getPersonId( ) const
{
	return getString("pid");
}

void
Sample::setAliquotId( const int id )
{
	setInt("aid", id);
	return;
}
...
int
Sample::getAliquotId( ) const
{
	return getInt("aid");
}

int
Sample::getCryovialId( ) const
{
	return getInt("crid");
}

void
Sample::setCryovialId( const int id )
{
	setInt("crid", id);
	return;
}
...
int
Sample::getCryovialStatus( ) const
{
	return getInt("crst");
}

void
Sample::setCryovialStatus( const int status )
{
	setInt("crst", status);
	return;
}
...
int
Sample::getJobno( ) const
{
	return getInt("jobno");
}

void
Sample::setJobno( const int no )
{
	setInt("jobno", no);
	return;
}
...
int
Sample::getNoteFlag( ) const
{
	return getInt("noteflag");
}

void
Sample::setNoteFlag( const int count )
{
...
int
Sample::getCryovialStoreId( ) const
{
	return getInt("csid");
}

void
Sample::setCryovialStoreId( const int id )
{
	setInt("csid", id);
	return;
}
...
// FIXME 6 begin
void
Sample::setNote( const std::string & note )
{
	setString("note", note);
	return;
}
...
int
CryovialStatus::getCurrentId( ) const
{
	int currentId = -1;
...
bool
CryovialStatus::setCurrentId( const int id )
{
	bool ok = false;
...
bool
CryovialStatus::setCurrentId( const std::string & name )
{
	bool ok = false;
...
int
CryovialStatus::getNextId( ) const
{
	int nextId = -1;
...
bool
CryovialStatus::setNextId( const int id )
{
	bool ok = false;
...
bool
CryovialStatus::setNextId( const std::string & name )
{
	bool ok = false;
...
int
Cells::setHeader( const Cell & cell )
{
	int nchanged = 0;
	if (isHeader(cell) == 0)
	{
...
int
Cells::clearHeader( const Cell & cell )
{
	int nchanged = 0;
	if (isHeader(cell) == 1)
	{
...
int
Cells::toggleHeader( const Cell & cell )
{
	int nchanged = 0;
	do
	{
...
int
Cells::isHeader( const Cell & cell )
{
...
Cells::getHeaderBegin( ) const
{
	return m_isheader.begin();
}

std::set<Cell>::const_iterator
Cells::getHeaderEnd( ) const
{
	return m_isheader.end();
}

void
Cells::setSampleno( const Cell & cell, const int sampleno )
{
...
int
Cells::getSampleno( const Cell & cell ) const
{
	int sampleno = -1;
