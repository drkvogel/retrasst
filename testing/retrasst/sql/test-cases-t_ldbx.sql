...
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-112, -623411, 0, 'Example retrieval box 2',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
 	values (-113, -623411, 0, 'Example retrieval box 3',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-114, -623411, 0, 'Example retrieval box 4',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-115, -623411, 0, 'Example retrieval box 5',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-116, -623411, 0, 'Example retrieval box 6',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-117, -623411, 0, 'Example retrieval box 7',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-118, -623411, 0, 'Example retrieval box 8',2,0,'now',0,0);
insert into box_name (box_cid, box_type_cid, box_capacity, external_name, status, slot_cid, time_stamp, note_exists, process_cid) 
	values (-119, -623411, 0, 'Example retrieval box 9',2,0,'now',0,0);
\p\g
