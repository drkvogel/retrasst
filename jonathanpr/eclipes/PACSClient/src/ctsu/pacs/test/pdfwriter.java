...
public class pdfwriter
{
	...
	public void Open(String ParticipentID,String DicomParticipantID) throws Exception
	{
		...
		Paragraph p = new Paragraph(10, 720, "Clinical report for participant: " + DicomParticipantID );
		write(p);
		contentStream.close();
	...
	public void write(Paragraph paragraph) throws IOException 
	{
	 ...
	 public void addBioBankLogo(int X, int Y,PDPage page) throws IOException
	 {
        PDXObjectImage ximage = null;

//      ximage = new PDCcitt(document, new RandomAccessFile(new File("biobank.jpg"),"r"));
