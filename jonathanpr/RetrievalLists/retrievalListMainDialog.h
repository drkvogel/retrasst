...
#ifndef retrievalListMainDialogH
#define retrievalListMainDialogH
//---------------------------------------------------------------------------
...
class TfrmRetrievalListViewListMain : public TForm
{
...
public:		// User declarations
	__fastcall TfrmRetrievalListViewListMain(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmRetrievalListViewListMain *frmRetrievalListViewListMain;
//---------------------------------------------------------------------------
#endif
